    ...
    <div className="w-full font-marathi relative z-[60]">
      ...
      <div className="bg-gradient-to-r from-lokmat-red to-lokmat-maroon text-white text-[9px] xs:text-[10px] sm:text-xs md:text-sm">
        <div className="parity-container flex justify-between items-center py-2 sm:py-3 font-bold">
          ...
          {/* Left: Marathi + Time + Date (VISIBLE ON ALL SCREENS) */}
          <div className="flex gap-2 xs:gap-3 sm:gap-4 items-center whitespace-nowrap">
            ...
            {time && (
              <span className="border-l border-white/20 pl-2 uppercase">
                {time.toDateString()}
              </span>
            )}
          </div>
          ...
          <div className="hidden md:flex gap-3 items-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center w-6 h-6 rounded-sm bg-white text-lokmat-red hover:bg-gray-100 hover:scale-110 transition shadow-sm"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center w-6 h-6 rounded-sm bg-white text-pink-600 hover:bg-gray-100 hover:scale-110 transition shadow-sm"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center w-6 h-6 rounded-sm bg-white text-red-600 hover:bg-gray-100 hover:scale-110 transition shadow-sm"
            >
