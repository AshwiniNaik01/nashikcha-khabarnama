...
const videos: VideoItem[] = [
    ...
    },
    {
        ...
        thumbnail: 'https://images.pexels.com/photos/708777/pexels-photo-708777.jpeg',
        duration: '०५:२०',
        category: 'शेती'
    },
    {
        ...
        thumbnail: 'https://static.vecteezy.com/system/resources/thumbnails/070/593/008/small/winter-night-in-urban-park-with-snow-and-soft-glow-of-lights-photo.jpeg',
        duration: '०२:१५',
        category: 'विकास'
    },
    {
        ...
        thumbnail: 'https://images.pexels.com/photos/730256/pexels-photo-730256.jpeg',
        duration: '०१:३०',
        category: 'नाशिक'
    }
];
    ...
    return (
        <section className="bg-gradient-to-b from-neutral-900 to-neutral-600 rounded-xl overflow-hidden shadow-2xl border border-white/5 my-12">
            <div className="p-8 md:p-12">
                <div className="flex justify-between items-center mb-10">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-2xl md:text-3xl font-black text-white uppercase tracking-tight">व्हिडीओ गॅलरी</h2>
                    ...
                    <div className="space-y-4 max-h-[450px] overflow-y-auto pr-2 custom-scrollbar">
                        {videos.map((video) => (
                            <div
                                ...
                                className={`flex gap-4 p-3 rounded-xl transition-all duration-300 cursor-pointer border ${activeVideo.id === video.id
            ...
            <div className="md:hidden p-6 pt-0">
                <button className="w-full py-4 border border-white/10 rounded-xl text-white font-black text-xs uppercase tracking-widest hover:bg-white/5 transition-all">
                    सर्व व्हिडीओ पाहा
                </button>
            </div>
        </section>
