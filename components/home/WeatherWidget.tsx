...
const WeatherWidget = () => {
  ...
  const weatherData = {
    ...
    forecast: [
      { day: "आज", high: "-°", low: "-°", icon: "☁️" },
      { day: "उद्या", high: "-°", low: "-°", icon: "⛅" },
      { day: "मंगळ", high: "-°", low: "-", icon: "☀️" },
      { day: "बुध", high: "-°", low: "-°", icon: "☀️" },
    ],
  };
    ...
    <div className="bg-white text-gray-900 rounded-lg shadow-md border border-gray-100 p-4">
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="text-right">
          <div className="text-3xl font-black text-lokmat-red">
      ...
      <div className="pt-3 border-t border-lokmat-red/10">
        <h4 className="font-bold mb-3 text-[10px] uppercase tracking-widest text-lokmat-red">
          पुढील अंदाज
        </h4>
        <div className="grid grid-cols-4 gap-2">
          {weatherData.forecast.map((day, index) => (
            <div key={index} className="text-center group">
              <div className="text-[10px] font-bold text-gray-400 group-hover:text-gray-900 transition-colors uppercase">
                {day.day}
              </div>
              <div className="text-xl my-1.5 transform group-hover:scale-110 transition-transform">
                {day.icon}
              </div>
