...
const BreakingNews: React.FC<BreakingNewsProps> = ({ newsItems = [] }) => {
  ...
  return (
    <div className="w-full flex justify-center bg-red-50 border-y border-red-100">
      <div className="parity-container py-1 xs:py-1.5 sm:py-2 flex items-center shadow-sm">
