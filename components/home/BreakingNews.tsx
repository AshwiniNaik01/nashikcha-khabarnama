...
const BreakingNews: React.FC<BreakingNewsProps> = ({ newsItems = [] }) => {
  ...
  return (
    <div className="relative z-10 bg-red-50 border-y border-red-100 overflow-hidden xs:py-1.5 sm:py-2 flex items-center shadow-sm mx-2 xs:mx-3 sm:mx-4 md:mx-6">
