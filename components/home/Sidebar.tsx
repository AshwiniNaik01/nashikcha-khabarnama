            ...
            <div className="relative mx-auto max-w-[280px] bg-white rounded-[2.5rem] border-8 border-gray-900 shadow-2xl overflow-hidden aspect-[9/18] flex flex-col">
                ...
                <div className="flex-1 flex flex-col pt-6 overflow-hidden">
                    ...
                    <div className="bg-lokmat-maroon p-4 flex flex-col items-center border-b border-lokmat-maroon">
                        <img src="/logo.png" alt="Logo" className="h-6 brightness-0 invert mb-1" />
                        <span className="text-[10px] text-white/80 font-black uppercase tracking-widest">ट्रेन्डिंग</span>
                    </div>

                    {/* Trending List */}
                    <div className="flex-1 overflow-y-auto p-4 custom-scrollbar bg-gray-50">
                        <h2 className="text-sm font-black text-gray-800 mb-4 border-b border-gray-200 pb-2">आजच्या महत्वाच्या</h2>
                        <div className="space-y-4">
                            {trendingItems.map((item, index) => (
                                <div key={item.id} className="flex gap-3 items-start group cursor-pointer border-b border-gray-100 pb-3 last:border-0 last:pb-0">
