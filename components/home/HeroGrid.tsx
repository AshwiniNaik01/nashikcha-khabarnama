        ...
        <section className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
                {sideArticles.map((article, i) => (
                    <div key={i} className="flex flex-col gap-3 group cursor-pointer border-b border-gray-100 pb-3">
                        ...
                        <div>
                            <span className="text-lokmat-red text-[10px] font-black uppercase tracking-wider">{article.category}</span>
