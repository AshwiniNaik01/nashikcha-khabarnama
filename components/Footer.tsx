...
export default function Footer() {
  return (
    <footer className="relative bg-[#0f0f0f] text-white pt-12 md:pt-20 pb-10 overflow-hidden">
      ...
      {/* Ambient background glow - Scale down for mobile */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-20 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          {/* 2. Quick Links */}
          <div className="space-y-6 md:space-y-8 sm:pl-8 sm:border-l border-white/5">
            <div className="relative">
              <h3 className="text-sm font-black uppercase text-lokmat-red">
                प्रमुख विभाग
              </h3>
              <div className="mt-2 w-8 h-0.5 bg-gray-700 mx-auto sm:mx-0"></div>
            </div>
          ...
          {/* 3. Information */}
          <div className="space-y-6 md:space-y-8 lg:pl-8 lg:border-l border-white/5">
            <div className="relative">
              <h3 className="text-sm font-black uppercase text-lokmat-red">
                माहिती
              </h3>
          ...
          <div className="space-y-6 md:space-y-8 lg:pl-8 lg:border-l border-white/5">
            ...
            <p className="text-gray-400 text-xs font-bold uppercase tracking-wider text-center sm:text-left">
              ताज्या अपडेट्ससाठी सबस्क्राईब करा:
            </p>
