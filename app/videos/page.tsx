...
const VideosPage = () => {
  ...
  return (
    <div className="bg-[#fcfcfc] dark:bg-zinc-950 min-h-screen font-sans selection:bg-red-100 selection:text-red-600 overflow-x-hidden">
              ...
              >
                ...
                <div className="p-4 md:p-5 flex flex-col flex-grow">
                  ...
                  <div className="mt-auto flex items-center justify-between pt-4 border-t border-zinc-50 dark:border-zinc-800">
                    ...
                    <button className="text-red-600 text-xs font-black flex items-center gap-1 group-hover:gap-2 transition-all uppercase">
        ...
        <section className="mb-12 md:mb-20">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-10">
            ...
            <div className="flex gap-3">
              <button className="w-10 h-10 md:w-12 md:h-12 rounded-xl border border-zinc-200 dark:border-zinc-800 flex items-center justify-center hover:bg-zinc-50 text-zinc-600">
                ←
              </button>
              <button className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-zinc-900 dark:bg-white text-white dark:text-black flex items-center justify-center hover:bg-red-600 transition-all shadow-lg">
                →
              </button>
            </div>
          </div>
