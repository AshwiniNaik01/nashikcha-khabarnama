...
"use client"; // हे Client Component असणे आवश्यक आहे कारण आपण URL Params वाचत आहोत

import React, { Suspense } from "react";
import { useSearchParams } from "next/navigation";
import RashiGrid from "@/components/rashi/RashiGrid";

// Metadata क्लायंट कंपोनेंटमध्ये वापरता येत नाही, 
// ते वेगळ्या layout.tsx मध्ये किंवा सेपरेट server component मध्ये ठेवावे.

const RashiContent = () => {
    const searchParams = useSearchParams();
    const selectedDate = searchParams.get("date"); // URL मधून 'date' मिळवा
    ...
    return (
        <div className="text-gray-900 relative min-h-[80vh] overflow-hidden rounded-3xl">
            ...
            <div className="py-2 md:py-2 relative z-10">
                ...
                {/* Zodiac Grid - तारीख प्रॉप म्हणून पाठवा */}
                <div className="animate-in fade-in slide-in-from-bottom-5 duration-1000">
...
// Next.js मध्ये searchParams वापरताना Suspense वापरणे गरजेचे आहे
